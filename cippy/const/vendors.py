...
VENDOR_ID_ROCKWELL: Final[int] = 1
VENDOR_NAME_ROCKWELL: Final[str] = "Rockwell Automation"

VENDORS: Final[dict[int, str]] = {
    VENDOR_ID_ROCKWELL: VENDOR_NAME_ROCKWELL,
    2: "Namco Controls Corp.",
    3: "Honeywell International Inc.",
    4: "Parker Hannifin Corporation",
    5: VENDOR_NAME_ROCKWELL,
    7: "SMC Corporation",
